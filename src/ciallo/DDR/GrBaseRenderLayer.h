...
class GrBaseRenderLayer : public Throwable,
                          public QObject
{
...
public:
    ~GrBaseRenderLayer() override;

    inline int32_t top() const
    { return fProperties.fTop; }
    inline int32_t left() const
    { return fProperties.fLeft; }
    inline int32_t width() const
    { return fProperties.fWidth; }
    inline int32_t height() const
    { return fProperties.fHeight; }
    inline int32_t zindex() const
    { return fProperties.fZIndex; }
    inline bool visible() const
    { return fProperties.fVisible; }
    ...
    */
    ...
    inline std::shared_ptr<GrBaseCompositor> asCompositor()
    { return fCompositor; }

protected:
    GrBaseRenderLayer(const std::string& inherit, int32_t x, int32_t y, int32_t z, int32_t w, int32_t h);

    virtual GrLayerResult onLayerResult() = 0;
...
private:
    ...
    void setCompositor(const std::shared_ptr<GrBaseCompositor>& ptr);
