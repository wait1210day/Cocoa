...
class GrNodeBadCastException : public ARTException
{
public:
    GrNodeBadCastException() = default;
    ~GrNodeBadCastException() override = default;
};

#define CIALLO_STATIC_NODE_KIND(kind)   const static NodeKind NODE_KIND = kind;
class BaseNode : public Throwable
{
public:
    enum class NodeKind
    {
...
protected:
    explicit BaseNode(const std::string& inherit, NodeKind kind, BaseNode *parent = nullptr);
    void parentDispose();
